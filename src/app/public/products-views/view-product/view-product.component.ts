...
export class ViewproductComponent implements OnInit {
    constructor(private route : ActivatedRoute, private productService : ProductsService,  private cookietoken:CookiesTokenService, private fb:FormBuilder, private cartService: CartService) { }
    product : Product | any;
